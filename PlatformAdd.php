...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO assets_hardware_platform (platform, comments) VALUES (%s, %s)",
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  ...
  <p>
    ...
    <input type="text" name="platform" value="" size="32">
  </p>
  <p>
